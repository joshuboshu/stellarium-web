...
<template>
  <div style="position: relative;">
    <v-text-field prepend-icon="search" label="Buscar..." v-model="searchText" @keyup.native.esc="resetSearch()" hide-details single-line dark v-click-outside="resetSearch"></v-text-field>
